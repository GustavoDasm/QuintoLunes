...
//Para ejecutar es npm run tarea5

console.log("Otra aclaracion para poner los datos primero es un enter y luego el dato")
...
console.log("Para poner los datos primero es un enter y luego el dato")
...
function intentoLogin() {
    let intentos = 0;
    const usuarioCorrecto = "gus";
    const contrasenaCorrecta = "1234";
    let usuario, contrasena;

    while (intentos < 3) {
        console.log("Usuario = gus\nContrasena = 1234")
        usuario = readline.question("Ingresa tu usuario:");
        contrasena = readline.question("Ingresa tu contrasena:");
